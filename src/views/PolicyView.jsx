    ...
    return (
        <div className={cls.policyWrapper}>
            ...
            <section>
                ...
                <Text p>
                    6.10. Иные цели, предусмотренные ч. 1 ст. 6 Федерального закона от 27 июля 2006 года №152-ФЗ «О персональных данных».
                </Text>
            </section>
            <section>
                <Text h2 className={cls.paragraphHeader}>
            ...
            <section>
                ...
                <Text p>
                    ...
                    <Link href={'https://mxscxde.ru/policy'} icon color>https://mxscxde.ru/policy</Link>.
                </Text>
            </section>
        </div>
    );
